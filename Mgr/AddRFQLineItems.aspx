<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddRFQLineItems.aspx.cs" Inherits="Mgr_AddRFQLineItems" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p><b>Contract Number: </b><asp:Label runat="server" ID="ContractNumber" /></p> 
            <p><b>RFQ Reference Number: </b><asp:Label runat="server" ID="RFQReference" /> </p>
    <p><b>RFQ Date: </b><asp:Label runat="server" ID="RFQDate" /></p> 
        <p><b>RFQ Sent to Vendor: </b><asp:Label runat="server" ID="RFQVendorDate" /></p> 
    ...
    <asp:Panel ID="filterJobBossPartsForm" CssClass="form-group" runat="server" DefaultButton="FilterJobBossPartsButton">
     ...
     <asp:GridView ID="JobBossPartsList" runat="server" AllowSorting="true" AutoGenerateColumns="false" ShowFooter="false" GridLines="Vertical" CellPadding="4" ItemType="JBXML.Respond.JBXMLJBXMLRespondMaterialListQueryRsMaterial"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton text="Add To RFQ" runat="server" CausesValidation="false" CommandName="AddToRFQ" CommandArgument='<%# Eval("Material") + "," + Container.DataItemIndex %>' ControlStyle-CssClass="btn btn-primary">
                    </asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
